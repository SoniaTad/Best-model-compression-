...
#input_data = np.array([[0, 78.9, 11.8]]) # Replace the values with your actual input data
...
input_data  =( np.array([[1, 79.9, 11.7], [1, 80.0, 12.2], [1, 79.9, 12.2], [0, 79.9, 13.0],[0, 82.9, 13.1]]))
